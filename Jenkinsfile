        ...
        steps {
            withCredentials([usernamePassword(
                ...
                script {
                    ...
                    def headRepo = "[https://github.com/$](https://github.com/$){env.GITHUB_USERNAME}/koreflow.git"
        ...
        steps {
            withCredentials([usernamePassword(
                ...
                script {
                    ...
                    def repoUrl = "[https://github.com/$](https://github.com/$){env.GITHUB_USERNAME}/koreflow.git"
